...
from model import models_mae_evolved_base as model_now

from engine.engine_pretrain_EMA import train_one_epoch
...
def main(args):
    ...
    # define the model
    model = model_now.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
